...
export default function Navbar({ onToggleTheme, isDark, userName }) {
  ...
  return (
    <div>
      {/* TOP NAVBAR */}
      <nav className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 fixed top-0 w-full z-30 md:w-[calc(100%-16rem)]">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              ...
              <button
                ...
                className="p-2 text-gray-500 rounded-lg md:hidden hover:bg-gray-100 dark:hover:bg-gray-700"
              >
