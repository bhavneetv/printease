                  ...
                  <div className="overflow-y-auto flex-1">
                    {notifications.slice(0, 3).map((notif) => (
                      <div
                        ...
                        className={`p-4 border-b border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer transition-colors duration-200 ${!notif.read ? 'bg-purple-50 dark:bg-purple-900/10' : ''
                          }`}
                      >
              ...
              <div className="space-y-3">
                {notifications.map((notif) => (
                  <div
                    key={notif.id}
                    onClick={() => markAsRead(notif.id)}
                    className={`p-4 rounded-lg border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer transition-colors duration-200 ${!notif.read ? 'bg-purple-50 dark:bg-purple-900/10 border-purple-200 dark:border-purple-800' : ''
                      }`}
                  >
                    <div className="flex items-start space-x-3">
                      <div className="mt-1">
