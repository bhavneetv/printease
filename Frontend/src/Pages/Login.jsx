...
export default function Login() {
  ...
  // Uncomment to enable test login
  loginTest();
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400 text-sm">
            {isLogin ? 'Sign in to manage your print shop and orders' : 'Create an account to get started'}
          </p>
        </div>
              ...
              {!isLogin && (
                <div className="mb-6">
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 bg-gray-50 dark:bg-gray-900 border ${errors.fullName ? 'border-red-500' : 'border-gray-300 dark:border-gray-600'
                ...
                <div className="mb-6">
                  ...
                  <div className="relative">
                    <input
                      ...
                      onKeyPress={handleKeyPress}
                      className={`w-full px-4 py-3 pr-12 bg-gray-50 dark:bg-gray-900 border ${errors.confirmPassword ? 'border-red-500' : 'border-gray-300 dark:border-gray-600'
                        } rounded-lg text-gray-900 dark:text-white focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all duration-200 outline-none`}
                      placeholder="••••••••"
                    />
                    <button
